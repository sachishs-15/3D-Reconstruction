...
def displayEpipolarF(I1, I2, F):
    ...
    while True:
        plt.sca(ax1)
        x, y = plt.ginput(1, mouse_stop=3)[0]   #right click to stop 
        ...
        if s==0:
            print('Zero line vector in displayEpipolar') #used print in place of error
...
def epipolarMatchGUI(I1, I2, F):
    ...
    while True:
        plt.sca(ax1)
        x, y = plt.ginput(1, mouse_stop=3)[0] #right click

        xc, yc = int(x), int(y)

        print("Point on image 1", xc, yc)
        ...
        if s==0:
            print('Zero line vector in displayEpipolar') #used print ipo error
        ...
        ax2.plot(p2[0][0], p2[0][1], 'ro', markersize=8, linewidth=2)   #initially = ax2.plot(p2[0,0], p2[0,1], 'ro', markersize=8, linewidth=2)
        #print("Point on image 2", p2[0][0], p2[0][1])
